...
# Valor seguro. Não use 9999.
const Z_INDEX_IMPACTOS: int = 100

var impactos_config: Array[Dictionary] = [
	{ "nome": "ImpactoPredio1", "x_ratio": 0.11, "y_ratio": 0.87, "width": 80.0, "scale_min": 0.20, "scale_max": 0.40, "texture_w": 2, "texture_h": 3 },
	{ "nome": "ImpactoPredio2", "x_ratio": 0.255, "y_ratio": 0.9792, "width": 35.0, "scale_min": 0.29, "scale_max": 0.39, "texture_w": 2, "texture_h": 2 },
	{ "nome": "ImpactoPredio3", "x_ratio": 0.38, "y_ratio": 0.9792, "width": 65.0, "scale_min": 0.39, "scale_max": 0.39, "texture_w": 2, "texture_h": 2 },
	{ "nome": "ImpactoPredio4", "x_ratio": 0.655, "y_ratio": 0.927, "width": 17.0, "scale_min": 0.29, "scale_max": 0.39, "texture_w": 1, "texture_h": 2 },
	{ "nome": "ImpactoPredio5", "x_ratio": 0.689, "y_ratio": 0.904, "width": 20.0, "scale_min": 0.37, "scale_max": 0.57, "texture_w": 1, "texture_h": 1 },
	{ "nome": "ImpactoPredio6", "x_ratio": 0.728, "y_ratio": 0.927, "width": 27.0, "scale_min": 0.29, "scale_max": 0.39, "texture_w": 1, "texture_h": 1 },
	{ "nome": "ImpactoPredio7", "x_ratio": 0.765, "y_ratio": 0.909, "width": 15.0, "scale_min": 0.29, "scale_max": 0.39, "texture_w": 1, "texture_h": 1 },
	{ "nome": "ImpactoPredio8", "x_ratio": 0.814, "y_ratio": 0.87, "width": 32.0, "scale_min": 0.29, "scale_max": 0.39, "texture_w": 1, "texture_h": 1 },
	{ "nome": "ImpactoPredio9", "x_ratio": 0.876, "y_ratio": 0.980, "width": 26.0, "scale_min": 0.29, "scale_max": 0.39, "texture_w": 1, "texture_h": 1 },
	{ "nome": "ImpactoPredio10", "x_ratio": 0.993, "y_ratio": 0.973, "width": 23.0, "scale_min": 0.29, "scale_max": 0.39, "texture_w": 1, "texture_h": 1 },
	{ "nome": "ImpactoPredio11", "x_ratio": 0.995, "y_ratio": 0.543, "width": 42.0, "scale_min": 0.37, "scale_max": 0.57, "texture_w": 2, "texture_h": 3 },
	{ "nome": "ImpactoPredio12", "x_ratio": 0.997, "y_ratio": 0.153, "width": 48.0, "scale_min": 0.37, "scale_max": 0.57, "texture_w": 2, "texture_h": 3 }
]
...
func _criar_impactos() -> void:
	...
	for config: Dictionary in impactos_config:
		...
		if config.has("texture_w"):
			texture_w = maxi(1, int(round(float(config["texture_w"]))))

		if config.has("texture_h"):
			texture_h = maxi(1, int(round(float(config["texture_h"]))))
...
func _criar_barra_horizontal(nome: String, pos: Vector2, largura: float, cor: Color) -> void:
	...
	poly.name = nome
	poly.color = cor
	poly.z_index = Z_INDEX_IMPACTOS + 1
	poly.position = pos
...
func _criar_faixa_impacto(
	...
	particles.z_index = Z_INDEX_IMPACTOS
	...
	particle_material.emission_box_extents = Vector3(largura * 0.5, 1.0, 0.0)
	...
	particle_material.gravity = Vector3(0.0, 110.0, 0.0)
